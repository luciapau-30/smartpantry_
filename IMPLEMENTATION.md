...
| **Background thread for expiry checking (T3)** | ✅ Done | `background/ExpiryCheckJob.java` scheduled every 5 min on the T2 pool; uses new `PantryItemDao.getExpiringSoonWithName(userId, 3)` |
